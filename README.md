...
> (full MERN stack + admin dashboard) reflect my drive to engineer complete, deployable solutions.
>
...
[![](https://skillicons.dev/icons?i=react,js,ts,html,css,tailwind&theme=dark)](https://skillicons.dev)
...
|:---|:---|:---|
| **AdFlow Pro** — Gig Marketplace | `React` `Node` `Express` `MongoDB` `JWT` | Multi-role auth · Full gig lifecycle · node-cron alerts · Role dashboards |
| **Salah Tracker** — Prayer App | `Flutter` `Dart` `Material Design` | 5-prayer tracking · Streak counter · 14-day calendar · Animated UI |
| **Drone Delivery System** — Web App | `MERN` `REST API` `Axios` `JWT` | Order placement · Status tracking · Admin dashboard · JWT auth |
| **Movie Recommendation App** — Web App | `React.js` `JSX` `CSS3` `ES6` | Dynamic grid · Watchlist · Real-time counter · Duplicate prevention |
...
&nbsp;
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=EIMAN-RAZA&layout=donut&hide_border=true&bg_color=161b22&title_color=58a6ff&text_color=c9d1d9&langs_count=6&hide=jupyter%20notebook" />
...
<a href="mailto:e1man.raza05@gmail.com">
  <img src="https://img.shields.io/badge/Gmail-e1man.raza05%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white&labelColor=161b22" />
</a>
&nbsp;
